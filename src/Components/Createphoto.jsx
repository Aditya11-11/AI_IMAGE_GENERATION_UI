...
const CharacterSelection = () => {
  ...
  useEffect(() => {
    localStorage.setItem("bodyShape", selectedShape);
    localStorage.setItem("breastSize", selectedBreastSize);
    localStorage.setItem("buttSize", selectedButtSize);
    localStorage.setItem("skinColor", selectedSkin);
  }, [selectedShape, selectedBreastSize, selectedButtSize, selectedSkin]);
