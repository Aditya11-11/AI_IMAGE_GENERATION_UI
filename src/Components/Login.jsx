...
const LoginPage = () => {
  ...
  const handlePasswordChange = async () => {
   ...
   const handleGoogleSignIn = () => {
    // Redirecting to the Google SignIn endpoint
    window.location.href = "https://image-generation-production.up.railway.app/login/google";
  };
  ...
  return (
    <div className="container-fluid" style={{ height: "100%" }}>
          ...
          >
            ...
            <div className="text-center mt-3">
              <span style={{ color: "#555" }}>
                Not have an account?{" "}
                <Link to="/signup" style={{ color: "#764ba2" }}>
                  Create an Account
                </Link>
              </span>
            </div>
            <div className="text-center my-3" style={{ color: "#555" }}>
              or with
            </div>
           <button
      type="button"
      ...
      onClick={handleGoogleSignIn} // Click event triggers the Google sign-in redirect
    >
      <img
